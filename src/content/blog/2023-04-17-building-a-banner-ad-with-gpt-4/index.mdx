...
pubDate: 2023-04-17
heroImage: "/media/building-a-banner-ad-with-gpt-4-gpt4-banner.png"
tags:
  - "ai"
  - "coding"
  - "design"
...
blocks:
  - _template: content
    body: "I've done a ton of banner ads in my career. I have been using chatGPT (and GPT-4) to play around with a few coding projects. So, I thought why not test if it can build an animated banner ad. How cool would that be?"
  - _template: content
    body: "# Can AI build an animated banner ad?"
  - _template: content
    body: "So I gave it a brief for a made up brand:"
  - _template: code
    language: "plaintext"
    code: |
  ...
  - _template: content
    body: "The generated code looked decent. The [code block had HTML, CSS, and JavaScript](https://github.com/hashmil/gpt4-banner-test/blob/main/v1.html) all in one place. After copying the code, I pasted it into Replit, and I was blown away by what I saw. Sure, the design isn't great and this might be boilerplate stuff in the world of Digital Display Advertising, but coding something simple would still take a bit of time – definitely not a couple of minutes! Oh, and don't forget that in my brief, I asked chatGPT to also write the copy for the banner ad too!"
  - _template: video
    type: "vimeo"
    url: "https://vimeo.com/818550369"
  - _template: content
    body: "It was a great starting point to see its capability. Then I started giving it feedback just like a creative director or client would."
  - _template: content
    body: "## The Final Version"
  - _template: content
    body: "After a bit of [back and forth](https://github.com/hashmil/gpt4-banner-test/blob/main/GPT4-banner-prompts.md), and a few cheeky manual tweaks in the code, I finally got a [final version](https://replit.com/@hashmil/CandA-Labs-Banner-v2) made. Now, we have a background image, some snazzy custom Google fonts, staggered animation, and a tidy look and feel. This banner might not be taking home any awards, but it's pretty insane what I managed to pull off in just 10 to 15 minutes!"
  - _template: video
    type: "vimeo"
    url: "https://vimeo.com/818550388"
  - _template: content
    body: "## The Future"
  - _template: content
