...
The [_whole project is open source on GitHub_](https://github.com/hashmil/karak-calculator), because I believe the world needs more tools that celebrate local culture through technology. It's a small love letter to the UAE's tea culture and the way karak brings people together across all walks of life.
