...
description: After two decades with After Effects, I finally tried DaVinci
  Resolve's Fusion. Here's what I learned about node-based compositing and
  motion graphics.
pubDate: 2025-07-16
...
![Screenshot of the Fusion node view showing connected nodes](/media/the-fusion-experiment-fusion-nodes.png)
...
<video controls loop playsinline autoplay muted>
  <source src="/media/the-fusion-experiment-animation.mp4" type="video/mp4" />
