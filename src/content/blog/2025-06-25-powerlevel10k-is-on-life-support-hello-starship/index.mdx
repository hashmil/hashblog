...
![A screenshot showing the default Warp terminal prompt alongside the Starship prompt.](/media/powerlevel10k-is-on-life-support-hello-starship-.png)
...
![A screenshot showing the final Starship prompt with the Catppuccin theme inside the Warp terminal.](/media/powerlevel10k-is-on-life-support-hello-starship-.png)
