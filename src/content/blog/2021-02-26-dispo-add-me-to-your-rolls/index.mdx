...
pubDate: 2021-02-26
heroImage: "/media/dispo-add-me-to-your-rolls-dispo-feature.jpg"
slug: "dispo-add-me-to-your-rolls"
blocks:
  - _template: content
    body: "Another social media app? Isn't this just another Instagram or even VSCO? Well... yes, and no. Hear me out, _[Dispo](https://dispo.fun/)_ is different."
  - _template: content
  ...
  - _template: content
    body: "https://twitter.com/chriscantino/status/1360730843841396736?s=21"
  - _template: content
    body: "#### Will it last or bite the dust?"
  - _template: content
    body: "Dispo has got [investors interested](https://www.tubefilter.com/2021/02/25/david-dobrik-dispo-reportedly-raises-20-million-200-million-valuation/), and looking at the buzz and enthusiasm around it, it does look like it has promise. As long as the team behind it can keep iterating and innovating to keep users come back for the longterm, and as long as they don't get complacent and drop the ball—I think these guys could get their own corner in the market."
  - _template: content
    body: "Eventually, like with all free platforms, Dispo will have to think of ways to monetising. The most obvious way is advertising—but I struggle to see how brands will fit into the app in a truly integrated way. I'm sure their super talented team has something in their back pockets, or they will think of something!"
  - _template: content
    body: "If you are on Dispo, I'm `@hash` over there. Add me to your rolls!"
  - _template: content
    body: "* * *"
  - _template: content
